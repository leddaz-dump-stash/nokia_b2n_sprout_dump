...
DEVICE_PATH := device/hmd/B2N_sprout
...
# Assert
TARGET_OTA_ASSERT_DEVICE := B2N_sprout
...
TARGET_KERNEL_SOURCE := kernel/hmd/B2N_sprout
TARGET_KERNEL_CONFIG := B2N_sprout_defconfig
